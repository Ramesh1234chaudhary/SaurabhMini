...
export function Services() {
    ...
    return (
        <StandardSection
            id="services"
            badge="⚖️ Our Legal View"
            title="Our Legal View"
                ...
                {allServices.map((service, _index) => (
                    <StaggerItem key={service.title}>
                        <motion.div
                            ...
                            style={{ borderRadius: "3rem", boxShadow: "0px 1px 1px white" }}
                            className="group bg-background-secondary border border-border-primary p-4 sm:p-6 hover:shadow-lg transition-all duration-300 h-full"
                        >
                            <div className="mb-4">
                                <ServiceIcon
                                    icon={service.icon}
